package com.cookmefsm.features.logoutsync.presentation
...
import com.cookmefsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.cookmefsm.features.billing.api.AddBillingRepoProvider
import com.cookmefsm.features.billing.model.AddBillingInputParamsModel
...
import com.cookmefsm.features.dashboard.presentation.ReasonDialog
...
import com.cookmefsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.cookmefsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.cookmefsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.cookmefsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.cookmefsm.features.orderhistory.model.*
...
import com.cookmefsm.features.quotation.model.AddQuotInputModel
import com.cookmefsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.cookmefsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.cookmefsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.cookmefsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.cookmefsm.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.cookmefsm.features.timesheet.model.AddTimeSheetInputModel
import com.cookmefsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.cookmefsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.cookmefsm.features.viewAllOrder.model.AddOrderInputProductList
import com.cookmefsm.mappackage.SendBrod
import com.cookmefsm.widgets.AppCustomTextView
import com.cookmefsm.MonitorService
import com.cookmefsm.MySingleton
import com.cookmefsm.features.addshop.model.*
import com.cookmefsm.features.addshop.model.assigntopplist.AddShopUploadImg
import com.cookmefsm.features.addshop.presentation.ShopExtraContactReq
...
import com.cookmefsm.features.login.model.GetConcurrentUserResponse
import com.cookmefsm.features.login.model.WhatsappApiData
import com.cookmefsm.features.performance.model.Gps_status_list
import com.cookmefsm.features.performance.model.UpdateGpsInputListParamsModel
import com.cookmefsm.features.returnsOrder.ReturnProductList
import com.cookmefsm.features.returnsOrder.ReturnRequest
import com.cookmefsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xcookmefsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xcookmefsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xcookmefsmlogsample/log.zip").path);
