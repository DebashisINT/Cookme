package com.cookmefsm.features.dashboard.presentation
...
import com.cookmefsm.*
import com.cookmefsm.R
import com.cookmefsm.app.*
import com.cookmefsm.app.NewFileUtils.browseDocuments
import com.cookmefsm.app.NewFileUtils.browsePDFDocuments
import com.cookmefsm.app.NewFileUtils.getExtension
import com.cookmefsm.app.domain.*
import com.cookmefsm.app.types.DashboardType
import com.cookmefsm.app.types.FragType
import com.cookmefsm.app.types.TopBarConfig
import com.cookmefsm.app.uiaction.DisplayAlert
import com.cookmefsm.app.utils.*
import com.cookmefsm.app.utils.AppUtils.Companion.isProfile
...
import com.cookmefsm.features.NewQuotation.*
import com.cookmefsm.features.NewQuotation.api.GetQuotRegProvider
import com.cookmefsm.features.NewQuotation.model.ViewDetailsQuotResponse
import com.cookmefsm.features.SearchLocation.SearchLocationFragment
import com.cookmefsm.features.SearchLocation.locationInfoModel
import com.cookmefsm.features.TA.ViewAllTAListFragment
import com.cookmefsm.features.achievement.AchievementFragment
import com.cookmefsm.features.activities.presentation.*
import com.cookmefsm.features.addAttendence.*
import com.cookmefsm.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.cookmefsm.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.cookmefsm.features.addAttendence.model.GetReportToFCMResponse
import com.cookmefsm.features.addAttendence.model.GetReportToResponse
import com.cookmefsm.features.addAttendence.model.Leave_list_Response
import com.cookmefsm.features.addorder.presentation.AddOrderFragment
...
import com.cookmefsm.features.addshop.presentation.OTPVerificationDialog
import com.cookmefsm.features.addshop.presentation.ScanImageFragment
import com.cookmefsm.features.addshop.presentation.ShowCardDetailsDialog
import com.cookmefsm.features.alarm.model.AlarmData
import com.cookmefsm.features.alarm.presetation.AttendanceReportFragment
import com.cookmefsm.features.alarm.presetation.PerformanceReportFragment
import com.cookmefsm.features.alarm.presetation.VisitReportDetailsFragment
import com.cookmefsm.features.alarm.presetation.VisitReportFragment
import com.cookmefsm.features.attendance.AttendanceFragment
import com.cookmefsm.features.attendance.api.AttendanceRepositoryProvider
import com.cookmefsm.features.attendance.model.AttendanceRequest
import com.cookmefsm.features.attendance.model.AttendanceResponse
import com.cookmefsm.features.averageshop.presentation.AverageShopFragment
import com.cookmefsm.features.avgorder.presentation.AverageOrderFragment
import com.cookmefsm.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.cookmefsm.features.beatCustom.TeamBeatListFragment
import com.cookmefsm.features.billing.presentation.AddBillingFragment
import com.cookmefsm.features.billing.presentation.BillingDetailsFragment
import com.cookmefsm.features.billing.presentation.BillingListFragment
import com.cookmefsm.features.changepassword.presentation.ChangePasswordDialog
import com.cookmefsm.features.chat.model.ChatListDataModel
import com.cookmefsm.features.chat.model.ChatUserDataModel
import com.cookmefsm.features.chat.model.GroupUserDataModel
import com.cookmefsm.features.chat.presentation.*
import com.cookmefsm.features.chatbot.presentation.ChatBotFragment
import com.cookmefsm.features.chatbot.presentation.ChatBotShopListFragment
import com.cookmefsm.features.chatbot.presentation.ReportsFragment
import com.cookmefsm.features.chatbot.presentation.SelectLanguageDialog
...
import com.cookmefsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.cookmefsm.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.cookmefsm.features.commondialogsinglebtn.OnDialogClickListener
import com.cookmefsm.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
...
import com.cookmefsm.features.contacts.ContactsAddFrag
import com.cookmefsm.features.contacts.ContactsFrag
import com.cookmefsm.features.dailyPlan.prsentation.AllShopListFragment
import com.cookmefsm.features.dailyPlan.prsentation.DailyPlanListFragment
import com.cookmefsm.features.dailyPlan.prsentation.PlanDetailsFragment
import com.cookmefsm.features.damageProduct.ShopDamageProductListFrag
import com.cookmefsm.features.damageProduct.ShopDamageProductSubmitFrag
import com.cookmefsm.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.cookmefsm.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.cookmefsm.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.cookmefsm.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.cookmefsm.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.cookmefsm.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.cookmefsm.features.dashboard.presentation.model.ContentListResponseModel
import com.cookmefsm.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.cookmefsm.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.cookmefsm.features.device_info.presentation.DeviceInfoListFragment
import com.cookmefsm.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.cookmefsm.features.document.DocumentRepoFeatureNewFragment
import com.cookmefsm.features.document.presentation.DocumentListFragment
import com.cookmefsm.features.document.presentation.DocumentTypeListFragment
import com.cookmefsm.features.document.presentation.OpenFileWebViewFragment
import com.cookmefsm.features.dymanicSection.presentation.AddDynamicFragment
import com.cookmefsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.cookmefsm.features.dymanicSection.presentation.DynamicListFragment
import com.cookmefsm.features.dymanicSection.presentation.EditDynamicFragment
import com.cookmefsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.cookmefsm.features.home.presentation.HomeFragment
import com.cookmefsm.features.homelocation.presentation.HomeLocationFragment
import com.cookmefsm.features.homelocation.presentation.HomeLocationMapFragment
import com.cookmefsm.features.know_your_state.KnowYourStateFragment
import com.cookmefsm.features.lead.LeadFrag
import com.cookmefsm.features.lead.ViewLeadFrag
import com.cookmefsm.features.leaveapplynew.LeaveHome
import com.cookmefsm.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.cookmefsm.features.localshops.LocalShopListFragment
import com.cookmefsm.features.localshops.LocalShopListMapFragment
import com.cookmefsm.features.localshops.NearByShopsMapFragment
import com.cookmefsm.features.location.*
import com.cookmefsm.features.location.api.LocationRepoProvider
import com.cookmefsm.features.location.model.*
import com.cookmefsm.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.cookmefsm.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.cookmefsm.features.login.ShopFeedbackEntity
import com.cookmefsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.cookmefsm.features.login.presentation.LoginActivity
import com.cookmefsm.features.logout.presentation.api.LogoutRepositoryProvider
import com.cookmefsm.features.logoutsync.presentation.LogoutSyncFragment
import com.cookmefsm.features.marketAssist.MarketAssistTabFrag
import com.cookmefsm.features.marketAssist.ShopDtlsMarketAssistFrag
import com.cookmefsm.features.marketAssist.ShopListMarketAssistFrag
import com.cookmefsm.features.marketing.presentation.MarketingPagerFragment
import com.cookmefsm.features.meetinglist.prsentation.MeetingListFragment
import com.cookmefsm.features.member.MapViewForTeamFrag
import com.cookmefsm.features.member.model.TeamLocDataModel
import com.cookmefsm.features.member.model.TeamShopListDataModel
import com.cookmefsm.features.member.presentation.*
import com.cookmefsm.features.menuBeat.MenuBeatFrag
import com.cookmefsm.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.cookmefsm.features.micro_learning.presentation.MicroLearningListFragment
import com.cookmefsm.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.cookmefsm.features.myallowancerequest.MyallowanceRequestFragment
import com.cookmefsm.features.myjobs.model.CustomerDataModel
import com.cookmefsm.features.myjobs.presentation.*
import com.cookmefsm.features.myorder.presentation.MyOrderListFragment
import com.cookmefsm.features.myprofile.presentation.MyProfileFragment
import com.cookmefsm.features.nearbyshops.api.ShopListRepositoryProvider
import com.cookmefsm.features.nearbyshops.model.ShopData
import com.cookmefsm.features.nearbyshops.model.ShopListResponse
import com.cookmefsm.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.cookmefsm.features.nearbyshops.presentation.BeatListFragment
import com.cookmefsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.cookmefsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.cookmefsm.features.nearbyshops.presentation.ShopCallHisFrag
import com.cookmefsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.cookmefsm.features.newcollection.CollectionDetailsStatusFragment
import com.cookmefsm.features.newcollection.CollectionShopListFragment
import com.cookmefsm.features.newcollection.NewCollectionListFragment
import com.cookmefsm.features.newcollectionreport.*
import com.cookmefsm.features.notification.NotificationFragment
import com.cookmefsm.features.orderList.NewDateWiseOrderListFragment
import com.cookmefsm.features.orderList.NewOrderListFragment
import com.cookmefsm.features.orderList.OrderListFragment
import com.cookmefsm.features.orderdetail.presentation.OrderDetailFragment
import com.cookmefsm.features.orderhistory.ActivityMapFragment
import com.cookmefsm.features.orderhistory.OrderhistoryFragment
import com.cookmefsm.features.orderhistory.TimeLineFragment
import com.cookmefsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.cookmefsm.features.orderhistory.model.LocationData
import com.cookmefsm.features.pendinglocationinout.PendingOutLocationFrag
import com.cookmefsm.features.performance.GpsStatusFragment
import com.cookmefsm.features.performance.PerformanceFragment
import com.cookmefsm.features.performance.api.UpdateGpsStatusRepoProvider
import com.cookmefsm.features.performance.model.UpdateGpsInputParamsModel
import com.cookmefsm.features.performanceAPP.OwnPerformanceFragment
import com.cookmefsm.features.performanceAPP.PerformanceAppFragment
import com.cookmefsm.features.performanceAPP.allPerformanceFrag
import com.cookmefsm.features.permissionList.ViewPermissionFragment
import com.cookmefsm.features.photoReg.*
import com.cookmefsm.features.privacypolicy.PrivacypolicyWebviewFrag
import com.cookmefsm.features.quotation.presentation.*
import com.cookmefsm.features.reimbursement.presentation.*
import com.cookmefsm.features.report.presentation.*
import com.cookmefsm.features.returnsOrder.*
import com.cookmefsm.features.settings.presentation.SettingsFragment
import com.cookmefsm.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.cookmefsm.features.shopdetail.presentation.*
import com.cookmefsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.cookmefsm.features.stock.StockDetailsFragment
import com.cookmefsm.features.stock.StockListFragment
import com.cookmefsm.features.stockAddCurrentStock.AddShopStockFragment
import com.cookmefsm.features.stockAddCurrentStock.UpdateShopStockFragment
import com.cookmefsm.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.cookmefsm.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.cookmefsm.features.stockCompetetorStock.AddCompetetorStockFragment
import com.cookmefsm.features.stockCompetetorStock.CompetetorStockFragment
import com.cookmefsm.features.stockCompetetorStock.ViewComStockProductDetails
import com.cookmefsm.features.survey.SurveyFrag
import com.cookmefsm.features.survey.SurveyViewDtlsFrag
import com.cookmefsm.features.survey.SurveyViewFrag
import com.cookmefsm.features.task.presentation.AddTaskFragment
import com.cookmefsm.features.task.presentation.CalenderTaskFragment
import com.cookmefsm.features.task.presentation.EditTaskFragment
import com.cookmefsm.features.task.presentation.TaskListFragment
import com.cookmefsm.features.taskManagement.TaskManagementFrag
import com.cookmefsm.features.taskManagement.ViewTaskManagementFrag
import com.cookmefsm.features.timesheet.presentation.AddTimeSheetFragment
import com.cookmefsm.features.timesheet.presentation.EditTimeSheetFragment
import com.cookmefsm.features.timesheet.presentation.TimeSheetListFragment
import com.cookmefsm.features.viewAllOrder.CartFragment
import com.cookmefsm.features.viewAllOrder.OrderTypeListFragment
import com.cookmefsm.features.viewAllOrder.ViewAllOrderListFragment
import com.cookmefsm.features.viewAllOrder.ViewCartFragment
import com.cookmefsm.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.cookmefsm.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.cookmefsm.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.cookmefsm.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.cookmefsm.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.cookmefsm.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.cookmefsm.features.viewPPDDStock.ViewOutstandingFragment
import com.cookmefsm.features.viewPPDDStock.ViewPPDDListFragment
import com.cookmefsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.cookmefsm.features.viewPPDDStock.ViewStockFragment
import com.cookmefsm.features.weather.presentation.WeatherFragment
import com.cookmefsm.mappackage.MapActivity
import com.cookmefsm.mappackage.MapActivityWithoutPath
import com.cookmefsm.mappackage.SendBrod
import com.cookmefsm.widgets.AppCustomEditText
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xcookmefsmlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xcookmefsmlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.cookmefsm/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xcookmefsmlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xcookmefsmlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xcookmefsmlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xcookmefsmlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
